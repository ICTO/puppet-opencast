...
class opencast (
  ...
  $seriesindex_folder     = $opencast::params::seriesindex_dir,
  $schedulerindex_folder  = $opencast::params::schedulerindex_dir,
  $archive_folder         = $opencast::params::archive_dir,
  $archiveindex_folder    = $opencast::params::archiveindex_dir,
  $files_folder           = $opencast::params::files_dir,
  $workspace_folder       = $opencast::params::workspace_dir,
  $workflowindex_folder   = $opencast::params::workflowindex_dir,
