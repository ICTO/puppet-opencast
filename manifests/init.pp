...
class opencast (
  ...
  $enable_workflowcleanup   = $opencast::params::enable_workflowcleanup,
  $lifetime_succeeded       = $opencast::params::lifetime_succeeded,
  $lifetime_failed          = $opencast::params::lifetime_failed,
  $lifetime_stopped         = $opencast::params::lifetime_stopped,
  $lifetime_parentless      = $opencast::params::lifetime_parentless
